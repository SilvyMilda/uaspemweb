...
include 'header.php';
// membuat variabel cek untuk dapat melakukan update dan tersimpan di database
if(isset($_GET['cek'])){
	$cek = $_GET['cek'];
	mysqli_query($conn, "UPDATE produksi SET cek = '$cek'");
}
// membuat variabel page untuk dapat melakukan hapus datainventory dan tersimpan di dalam database
if(isset($_GET['page'])){
	$kode = $_GET['kode'];
